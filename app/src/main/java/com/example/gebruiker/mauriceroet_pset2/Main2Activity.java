...
public class Main2Activity extends AppCompatActivity {
    ...
    // Empties the text box so that the user can fill in the next word.
    ...
    public void createText(Story story){
        ...
        TextView word_type = findViewById(R.id.word_type);
        EditText hint_word = findViewById(R.id.given_word);
